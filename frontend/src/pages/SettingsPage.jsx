...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-20 md:py-24 container mx-auto max-w-5xl">
          ...
          <div className="rounded-xl border border-base-300 bg-base-100 shadow-sm overflow-hidden">
            <div className="p-4 bg-base-200">
              <div className="w-full max-w-lg mx-auto">
                {/* Mock Chat UI */}
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden flex flex-col h-full">
                  {/* Chat Header */}
                  ...
                  {/* Chat Messages */}
                  <div className="flex-1 p-4 space-y-4 overflow-y-auto min-h-[200px] max-h-[300px] bg-base-100">
